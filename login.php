...
elseif (isset($_SESSION['doc_name'])) {
  header('location:doctor/doctor_page.php');
}

// // elseif ($_SESSION['doc_name']==true) {
// //   header('location:doctor/doctor_page.php');
// // }
...
<div id="home" class="fullscreen background parallax sec_one" data-img-width="1600" data-img-height="1064" data-diff="100" style="background-attachment: fixed; background-size: 1112.78px 740px; background-position: 50% -124.167px;">
...
<div class="wrapper">
  ...
  <div class="signup-form">
    ...
    <div class="text-box">
    <input type="number" placeholder="Your Contact number" name="mob" required="">
  </div>
    <div class="text-box">
    <input type="text" placeholder="Your Email Address" name="email" required="">
  </div>
  <div class="text-box">
    <input type="password" placeholder="Choose a Password" name="pwd" required="">
  </div><br/>
  <div class="rbtn">
    <img src="images/doctor.png" height="35px" width="35px">
    <input type="radio" name="type" value="doctor" onclick="function f()" required=""> Doctor &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  

<img src="images/patient.png" height="35px" width="35px">
<input type="radio" name="type" value="patient" onclick="function e()" name="radio"> Patient

<div id="textboxes" style="display: none">
<div class="text-box">
<select class="option_doctor" name="gender" style="color: black;">
  <option>select gender</option >
  <option value="male">Male</option>
  <option value="female">Female</option> 
</select>
</div>
<div class="text-box"><input type="text" placeholder="Age" name="age"></div>
</div>


<div id="textboxe" style="display: none">
<div class="text-box"><input type="text" placeholder="Enter Specialization" name="Specialization"></div>
<div class="text-box"><input type="text" placeholder="Enter Hospital Name" name="hname" >
</div>
<div class="text-box"><input type="text" placeholder="Hospital Address" name="haddress"></div>
</div>
  ...
  <script>
$(function f() {
    $('input[name="type"]').on('click', function f() {
        if ($(this).val() == 'doctor') {
            $('#textboxe').show();
        }
...
$(function e() {
  ...
  <input type="submit" value="Create Account" class="btn" name="sub1">
...
<div class="text-box"><input type="text" placeholder="Email or Username" name="uname" required=""></div>
<div class="text-box"><input type="password" placeholder="Password" name="pwd" required=""></div><br/>

<div class="rbtn">

<img src="images/doctor.png" height="35px" width="35px">
<input type="radio" name="dept" value="doctor" required=""> Doctor &nbsp;&nbsp;&nbsp;&nbsp;
<img src="images/patient.png" height="35px" width="35px">
<input type="radio" name="dept" value="patient"> Patient

</div>
<span><a href="#">Forgot username or password.</a></span>
<input type="submit" class="btn" name="sub2">
...
<div class="modal fade" id="Disclaimer" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h1>Disclaimer- ‘Life Support’ is Not a Medical Referral Service</h1>
      ...
      <h1>Disclaimer- Life Support- A Health Care Facilitator</h1>
...
<div class="ftl"><h1><img src="images/LS.png" height="42" width="42"></h1></div>
<!--<h2>dfsgdfs</h2>-->
...
if($dept=='doctor'){
  ...
  $sql1="select doctorname , password from doctor where doctorname= '".$uname."' and password='".$pwd."' ";
...
if ($result->num_rows > 0) {
   $_SESSION['doc_name']=$uname;
     echo '<script type="text/javascript">window.location.replace("doctor/doctor_page.php");</script>';
     
     echo "index page";
    }
    else {
    echo '<script type="text/javascript">alert("username/password is incorrect");window.location.replace("login.php");</script>';
    echo "login page";
}
echo $sql1;
} 
...
elseif ($dept=='patient') {
  $sql2="select patientname , password from patient where patientname= '".$uname."' and password='".$pwd."' ";

      $result = $conn->query($sql2);

if ($result->num_rows > 0) {
  $_SESSION['patientname']=$uname;
     echo '<script type="text/javascript">window.location.replace("patient/patient_page.php");</script>';
     echo "index page";
    }
    else {
    echo '<script type="text/javascript">alert("username/password is incorrect");window.location.replace("login.php");</script>';
  ...
  echo('please select radio button');   //ye else part optional hai....okkkkk
}
}
