...
include_once('../dbmanager.php');
 $doc_profile=$_SESSION['doc_name'];
if($doc_profile==false){
...
<?php 
$sql3="SELECT Specialization FROM doctor WHERE doctorname='".$doc_profile."' ";
...
<link rel="icon" href="../images/doctor.png" type="image/x-icon">
...
<nav class="navbar navbar-default navigation navbar-fixed-top">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <div><a class="navbar-brand" href="#" style="color:#fff;">Life Support</a>
    ...
    <li><font color="white"><?php echo "welcome! "; echo $doc_profile;?></font></li>
...
<div class="view_appointment_doctor"><img src="../images/viewappointment.png" style="height: 50px; width:50px;"><br>View Appointments</div>
<div class="appointment_history_doctor"><img src="../images/appointmenthistory.png" style="height: 50px; width:50px;"><br>Appointment History</div>
<div class="give_prescription"><img src="../images/prescription_1.png" style="height: 50px; width:50px;"><br>Give Prescription</div>
<div class="view_report_doctor"><img src="../images/viewreport.png" style="height: 50px; width:50px;"><br>View Report</div>
...
<div class="report_css">
    <img src="../images/ic_logo.png" style="height:100px; width:100px; align-items: center;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><font size="5"><b>Life Support</b></font></u>
    <div class="txtinput">
  Name:<input type="text"> Age:<input type="text"> Sex:<select><option>Male</option><option>Female</option></select><br><br>
  Address:<textarea placeholder="address" cols="40" rows="2"></textarea>Date:<input type="date"><br><br>
  <textarea placeholder="prescription details" cols="90" rows="10"></textarea>
  Recommendation:<textarea cols="20" rows="2"></textarea><br>
  Examined By:<input type="text"><br>
...
<div class="txtbox">
    <img src="images/ic_logo.png" align="left" style="height:100px; width:100px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><font size="5" ><b>Life Support</b></font></u>
...
<div class="view_app_css">
    <?php
    $query="SELECT * FROM appointment WHERE service ='".$Specialization."' ";
    $data_appoint=mysqli_query($conn,$query);
    $total=mysqli_num_rows($data_appoint);
    if($total!=0)
    {
      ?>
      <style>
      ...
      <table align="center">
      <caption style="color:black; text-align:center;">Patient Appointment Details</caption>
      <tr>
        <th>Id</th>
        <th>Name</th>
        <th>Mobile No</th>
      ...
      <?php
      while($result=mysqli_fetch_assoc($data_appoint))
      {
        echo"<tr>
        <td>".$result['id']."</td>
        <td>".$result['Name']."</td>
        ...
        <td><a href='#' id='myBtn'>Status</a></td>
...
<div class="his_app">
    <img src="images/ic_logo.png" style="height:100px; width:100px; align-items: left;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><font size="5"><b>Life Support</b></font></u>
    <div class="txtinput">
  Name:<input type="text"> Age:<input type="text"> Sex:<select><option>Male</option><option>Female</option></select><br><br>
  Address:<textarea placeholder="address" cols="40" rows="2"></textarea>Date:<input type="date"><br><br>
  <textarea placeholder="prescription details" cols="90" rows="10"></textarea>
...
<!---Dcoctor precription end --> 
<!---Dcoctor report start--> 
...
$(".give_prescription").click(function () {
  $(".his_app").hide();
  $(".txtbox").show();
  $(".report_css").hide();
  $(".view_app_css").hide();

  $(".appointment_history_doctor").css("background", "white");
  $(".view_appointment_doctor").css("background", "white");
  $(".view_report_doctor").css("background", "white");
  $(".give_prescription").css("background", "#00ffff");
});

$(".view_report_doctor").click(function () {
$(".report_css").show();
$(".txtbox").hide();
$(".his_app").hide();
$(".view_app_css").hide();
$(".give_prescription").css("background", "white");
$(".view_report_doctor").css("background", "#00ffff");
 $(".appointment_history_doctor").css("background", "white");
  $(".view_appointment_doctor").css("background", "white");
});
$(".appointment_history_doctor").click(function () {
$(".his_app").show();
$(".txtbox").hide();
$(".report_css").hide();
$(".view_app_css").hide();
$(".give_prescription").css("background", "white");
$(".view_report_doctor").css("background", "white");
 $(".appointment_history_doctor").css("background", "#00ffff");
  $(".view_appointment_doctor").css("background", "white");
});
$(".view_appointment_doctor").click(function () {
$(".view_app_css").show();
$(".txtbox").hide();
$(".his_app").hide();
$(".report_css").hide();
...
$(".view_report_doctor").css("background", "white");
 $(".appointment_history_doctor").css("background", "white");
  $(".view_appointment_doctor").css("background", "#00ffff");
});
...
<li><a href="#"><img src="..
  images/dot3.png" width="16" height="12">contact@lifesupport.com</a></li>
</ul>
