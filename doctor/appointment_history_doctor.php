...
<a href="view_appointment.php"><div class="view_appointment_doctor"><img src="images/viewappointment.png" style="height: 50px; width:50px;"><br>View Appointments</div></a>
