...
<nav class="navbar navbar-default navigation navbar-fixed-top">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#"><div class="btnl"><font color="white">Log out</font></div></a></li>
...
<a href="view_appointment_doctor.php"><div class="view_appointment_doctor"><img src="images/viewappointment.png" style="height: 50px; width:50px;"><br>View Appointments</div></a>
<a href="appointment_history_doctor.php"><div class="appointment_history_doctor"><img src="images/appointmenthistory.png" style="height: 50px; width:50px;"><br>Appointment History</div></a>
<a href="give_prescription.php"><div class="give_prescription"><img src="images/prescription.png" style="height: 50px; width:50px;"><br>Give Prescription</div></a>
<a href="view_report_doctor.php"><div class="view_report_doctor"><img src="images/viewreport.png" style="height: 50px; width:50px;"><br>View Report</div></a>
