...
<div id="home" class="fullscreen background parallax sec_one" data-img-width="1600" data-img-height="1064" data-diff="100" style="background-attachment: fixed; background-size: 1112.78px 740px; background-position: 50% -91.3095px;">
 
  

<a href="hospital_near.php"><div class="hospital_near_me"><img src="../images/nearme.png" style="height: 50px; width:50px;"><br>Hospital Near me</div></a>
<a href="take_appointment.php"><div class="take_appointment"><img src="../images/takeappointment.png" style="height: 50px; width:50px;"><br>Take Appointment</div></a>
<a href="view_appointment.php"><div class="view_appointment"><img src="../images/viewappointment.png" style="height: 50px; width:50px;"><br>View Appointment</div></a>
<a href="appointment_history.php"><div class="appointment_history"><img src="../images/appointmenthistory.png" style="height: 50px; width:50px;"><br>Appointment History</div></a>
<a href="view_prescription.php"><div class="view_prescription"><img src="../images/prescription.png" style="height: 50px; width:50px;"><br>View Prescription</div></a>
<a href="view_report.php"><div class="view_report"><img src="../images/viewreport.png" style="height: 50px; width:50px;"><br>View Report/Upload    </div></a>
     
<div id="map" class="map">
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC-JGpOA1HglDHMaP3w8S2e6udkcMxPnHE&libraries=places&callback=initMap" async defer></script>
</div>
