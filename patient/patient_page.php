...
<nav class="navbar navbar-default navigation navbar-fixed-top">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <div><a class="navbar-brand" href="#" style="color:#fff;">Life Support 
        <?php echo "hello"; echo $patient_profile; ?>
      </a></div>
    </div>
...
<a href="hospital_near.php">
  <div class="hospital_near_me"><img src="../images/nearme.png" style="height: 50px; width:50px;"><br>Hospital Near me
  </div>
</a>
<a href="take_appointment.php">
  <div class="take_appointment"><img src="../images/takeappointment.png" style="height: 50px; width:50px;"><br>Take Appointment
  </div>
</a>
<a href="view_appointment.php">
  <div class="view_appointment"><img src="../images/viewappointment.png" style="height: 50px; width:50px;"><br>View Appointment
  </div>
</a>
<a href="appointment_history.php">
  <div class="appointment_history"><img src="../images/appointmenthistory.png" style="height: 50px; width:50px;"><br>Appointment History
  </div>
</a>
<a href="view_prescription.php">
  <div class="view_prescription"><img src="../images/prescription_1.png" style="height: 50px; width:50px;"><br>View Prescription
  </div>
</a>
<a href="view_report.php">
  <div class="view_report"><img src="../images/viewreport.png" style="height: 50px; width:50px;"><br>View Report/Upload    
  </div>
</a>
