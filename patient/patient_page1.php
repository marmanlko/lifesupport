...
<div class="hospital_near_me"><img src="images/nearme.png" style="height: 50px; width:50px;"><br>Hospital Near me</div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC-JGpOA1HglDHMaP3w8S2e6udkcMxPnHE&libraries=places&callback=initMap" async defer>
</script>
</div>
...
<script id="rendered-js">
  ...
  $(".map").hide();
  $(".hospital_near_me").css("background", "white");
  $(".hospital_near_me").click(function () {
  $(".map").show();
  $('map').on('click',initMap())
  $(".hospital_near_me").css("background", "blue");
});
